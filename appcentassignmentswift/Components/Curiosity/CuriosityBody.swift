            ...
            Group {
                if(viewModel.isFirstFetchLoading) {
                    ...
                    NavigationStack {
                        ...
                        }.navigationTitle("Curiosity").toolbar {
                            toolBarItems()
                        }
                    }
...
struct CuriosityBody_Previews: PreviewProvider {
    static var previews: some View {
        CuriosityBody().environmentObject(CuriosityViewModel())
    }
}
